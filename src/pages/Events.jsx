...
export default function Events() {
  ...
  const filteredEvents = eventsData.filter(event => {
    ...
    const matchesSearch = !cleanSearch ||
      ...
      event.speaker.name.toLowerCase().includes(cleanSearch);
                ...
                >
                  ...
                  <div className="flex items-center justify-between pt-5 mt-6 border-t border-slate-50">
                    <div className="flex items-center gap-2.5">
                      <img src={evt.speaker.avatar} alt={evt.speaker.name} className="w-9 h-9 rounded-xl object-cover border border-slate-100" />
                      <div className="text-left min-w-0">
                        <div className="text-[12px] font-bold text-[#110051] truncate">{evt.speaker.name}</div>
                        <div className="text-[10px] text-slate-400 font-semibold truncate">{evt.speaker.role}</div>
                      </div>
                    </div>
