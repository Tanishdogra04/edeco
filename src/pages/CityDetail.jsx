  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans selection:bg-brand-200 selection:text-brand-900">
      ...
      <main className="flex-1">
        ...
        <div className="bg-slate-50 border-b border-slate-200 pt-24 pb-4">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center text-sm text-slate-500 gap-2">
              ...
              <Link to="/cities" className="hover:text-slate-900 transition-colors">Cities</Link>
              <ChevronRight size={14} />
              <span className="text-brand-600 font-medium">{cityName}</span>
            </div>
          </div>
        </div>

        {/* Hero Section */}
        <section className="pt-4 pb-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative rounded-[2rem] overflow-hidden shadow-2xl bg-slate-900 pt-16 pb-16 px-6 sm:px-12 text-center">
            ...
            <div className="relative z-10">
              ...
              >
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-brand-200 mb-6 shadow-sm">
                  <MapPin size={16} />
                  <span className="text-sm font-semibold tracking-wide uppercase">Top Educational Hub</span>
                </div>
                
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight mb-6">
                  Top Colleges in <span className="text-white">{cityName}</span>
                </h1>
                
                <p className="text-base sm:text-lg text-slate-200 mb-10 max-w-2xl mx-auto font-light leading-relaxed">
                  Explore the best engineering, management, medical, and technology institutes. Discover fees, placements, rankings, and more.
                </p>

                {/* Search Bar */}
                <div className="max-w-2xl mx-auto bg-white rounded-2xl p-2 shadow-2xl flex items-center gap-2 relative z-20">
                  ...
                  <input 
                    ...
                    placeholder={`Search for colleges, courses, or exams in ${cityName}...`}
                    className="w-full py-3 px-2 bg-transparent border-none outline-none text-slate-800 placeholder:text-slate-400 text-lg font-medium"
                  />
                  <button className="bg-brand-600 hover:bg-brand-700 text-white px-6 py-3 rounded-xl font-semibold transition-colors whitespace-nowrap hidden sm:block">
                    Search
                  </button>
                </div>
                ...
                <div className="mt-10 flex flex-wrap justify-center gap-3">
                  {categories.map((cat, idx) => (
                    <button
                      ...
                      className={`px-5 py-2.5 rounded-full text-sm font-bold transition-all duration-300 backdrop-blur-md border ${
                        activeCategory === cat 
                          ? 'bg-gradient-to-r from-brand-500 to-brand-600 text-white border-transparent shadow-lg shadow-brand-500/40' 
                ...
                <div className="mt-12 flex justify-center animate-bounce">
                  <button 
                    ...
                    className="p-3 rounded-full bg-white/10 hover:bg-white/20 text-white backdrop-blur-sm transition-all border border-white/20 shadow-lg"
                    aria-label="Scroll to colleges"
                  >
                    <ChevronDown size={24} />
                  </button>
                </div>
        ...
        {/* Counselling CTA */}
        <CounsellingCTA onCounsellingClick={() => {}} />
