      ...
      columns: [
        {
          title: "Top Domains",
          links: [
            { name: "Engineering Colleges", href: "#colleges", icon: Laptop },
            { name: "Business Schools", href: "#colleges", icon: GraduationCap },
            { name: "Medical Institutes", href: "#colleges", icon: HeartPulse },
            { name: "Law Academies", href: "#colleges", icon: Scale },
          ]
        },
        {
          title: "Premium Services",
          links: [
            { name: "Admission Guidance", href: "#counselling", icon: Sparkles, badge: "Popular" },
            { name: "AI College Finder", href: "#hero", icon: Award },
            { name: "Expert Consultation", href: "#counselling", icon: PhoneCall },
          ]
        }
      ]
    },
      ...
      columns: [
        {
          ...
          links: [
            { name: "B.Tech / B.E.", desc: "4 Years • Technology", href: "#courses" },
            { name: "BBA / BCA", desc: "3 Years • Management/IT", href: "#courses" },
            { name: "MBBS", desc: "5.5 Years • Medical", href: "#courses" },
            { name: "B.Des / B.Arch", desc: "4-5 Years • Creative", href: "#courses" },
          ]
        },
        {
          title: "Postgraduate (PG)",
          links: [
            { name: "MBA / PGDM", desc: "2 Years • Business Leaders", href: "#courses", badge: "Hot" },
            { name: "M.Tech", desc: "2 Years • Specialization", href: "#courses" },
            { name: "MCA / M.Sc", desc: "2 Years • Advanced Tech", href: "#courses" },
            { name: "LL.B / LL.M", desc: "3-2 Years • Law", href: "#courses" },
          ]
        }
      ]
    },
      ...
      columns: [
        {
          ...
          links: [
            { name: "JEE Main / Advanced", desc: "Engineering Entrance", href: "#exams" },
            { name: "NEET UG", desc: "Medical Entrance", href: "#exams" },
            { name: "GATE", desc: "Postgrad Tech", href: "#exams" },
          ]
        },
        {
          title: "Management & Others",
          links: [
            { name: "CAT / XAT / CMAT", desc: "Management Admissions", href: "#exams", badge: "Trending" },
            { name: "CUET", desc: "Central Universities", href: "#exams" },
            { name: "CLAT", desc: "Law Admissions", href: "#exams" },
          ]
        }
      ]
    },
      ...
      columns: [
        {
          ...
          links: [
            { name: "College Comparison Guides", href: "#news" },
            { name: "Exam Strategy & Preparation", href: "#news" },
            { name: "Admission Policy Updates", href: "#news", badge: "New" },
            { name: "Student Success Stories", href: "#news" },
          ]
        }
      ]
    }
      ...
      <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            {/* Logo */}
            <div className="flex items-center gap-2.5 cursor-pointer px-3.5 py-1.5 rounded-full bg-slate-50/50 hover:bg-slate-100/70 border border-slate-100/40 hover:border-slate-200/50 shadow-sm transition-all duration-300 group" onClick={() => window.scrollTo({top:0, behavior:'smooth'})}>
            ...
            <div className="hidden lg:flex items-center gap-1 xl:gap-2 ml-8">
                      ...
                      {activeDropdown === key && (
                        ...
                        >
                          ...
                          <div className="col-span-2 pt-4 border-t border-slate-50 flex items-center justify-between text-xs text-slate-400">
                            ...
                            <a href="#counselling" onClick={() => setActiveDropdown(null)} className="flex items-center gap-1 font-semibold text-brand-600 hover:text-brand-700 transition-colors group/link">
                              Talk to Counselors
              ...
              <a href="#footer" className="px-3 py-1.5 rounded-lg text-[15px] font-medium text-slate-600 hover:text-brand-600 hover:bg-slate-50 transition-all">
                Contact
              </a>
            </div>
            ...
            <div className="hidden lg:flex items-center gap-4">
              <button className="flex items-center gap-1.5 text-[15px] font-semibold text-slate-700 hover:text-brand-600 transition-colors py-2 px-3">
                <LogIn size={16} />
                <span>Login</span>
              </button>
            ...
            <>
              ...
              >
                ...
                <div className="flex-1 py-6 space-y-5">
                  ...
                  <div className="pt-4 border-t border-slate-100">
                    <a
                      href="#colleges"
                      onClick={toggleMenu}
                      className="flex items-center justify-between p-2 rounded-lg hover:bg-slate-50 text-[14px] text-slate-700 font-semibold hover:text-brand-600"
                    >
                ...
                <div className="pt-6 border-t border-slate-100 space-y-3">
                  ...
                  <button className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border border-slate-200 text-slate-700 font-semibold text-sm hover:bg-slate-50">
                    <LogIn size={16} />
                    Log In
                  </button>
                </div>
