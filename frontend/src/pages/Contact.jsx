        ...
        <div className="bg-[#0F141E] pt-32 pb-16 relative overflow-hidden border-b border-slate-800 text-left">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight mb-5 font-tt-talent leading-tight max-w-3xl" style={{ fontFamily: '"TT Talent", sans-serif' }}>
              Get in Touch with <span className="text-[#0f71cd]">Edeco Support</span>
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid lg:grid-cols-12 gap-12 sm:gap-16 text-left">
            ...
            <div className="lg:col-span-5 space-y-8">
              <div>
                <h3 className="text-2xl font-bold text-[#0F141E] mb-3 font-tt-talent" style={{ fontFamily: '"TT Talent", sans-serif' }}>Let's start a conversation</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="p-6 bg-white rounded-3xl border border-slate-100 shadow-[0_4px_25px_rgba(0,0,0,0.015)] flex gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-slate-50 text-[#0f71cd] flex items-center justify-center shrink-0 border border-slate-200">
                    <Phone size={22} />
                  </div>
                  <div>
                    ...
                    <a href="tel:+918278713791" className="text-[#0f71cd] font-bold text-sm hover:underline hover:text-[#0c62b2] transition-colors">+91 82787 13791</a>
                  </div>
                </div>
                ...
                <div className="p-6 bg-white rounded-3xl border border-slate-100 shadow-[0_4px_25px_rgba(0,0,0,0.015)] flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@edeco.edu" className="text-[#0f71cd] font-bold text-sm hover:underline hover:text-[#0c62b2] transition-colors">hello@edeco.edu</a>
                  </div>
                </div>
                ...
                <div className="p-6 bg-white rounded-3xl border border-slate-100 shadow-[0_4px_25px_rgba(0,0,0,0.015)] flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[13.5px] text-[#0F141E] font-bold leading-relaxed mb-2 font-tt-talent" style={{ fontFamily: '"TT Talent", sans-serif' }}>Edeco Headquarters</p>
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-1 text-xs font-bold text-[#0f71cd] hover:text-[#0c62b2] hover:underline transition-all"
                    >
                ...
                <AnimatePresence mode="wait">
                  {isSubmitSuccess ? (
                    ...
                    >
                      ...
                      <h4 className="text-2xl font-bold text-[#0F141E] mb-2 font-tt-talent" style={{ fontFamily: '"TT Talent", sans-serif' }}>Message Sent Successfully!</h4>
                      ...
                      <button
                        ...
                        className="mt-8 px-8 py-3 bg-[#0f71cd] hover:bg-[#0c62b2] text-white text-xs font-bold rounded-xl transition-all cursor-pointer font-tt-talent"
                    ...
                    <form key="form" onSubmit={handleFormSubmit} className="space-y-5">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                          ...
                          <input
                            ...
                            placeholder="John"
                            className="w-full mt-1.5 p-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:border-[#0f71cd] focus:ring-2 focus:ring-[#0f71cd]/10 outline-none transition-all text-xs font-semibold text-slate-800"
                          />
                        </div>
                        <div>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full mt-1.5 p-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:border-[#0f71cd] focus:ring-2 focus:ring-[#0f71cd]/10 outline-none transition-all text-xs font-semibold text-slate-800 text-left"
                        >
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full mt-1.5 p-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:border-[#0f71cd] focus:ring-2 focus:ring-[#0f71cd]/10 outline-none transition-all text-xs font-semibold text-slate-800 resize-none"
                        />
                      </div>
                      ...
                      <button
                        ...
                        className="w-full bg-[#0f71cd] hover:bg-[#0c62b2] text-white font-bold py-4 rounded-xl transition-colors flex items-center justify-center gap-2 cursor-pointer shadow-sm text-sm font-tt-talent"
                        style={{ fontFamily: '"TT Talent", sans-serif' }}
                      >
                        {isSubmitting ? (
        ...
        <div className="bg-slate-100/50 py-16 border-t border-b border-slate-200/40 text-left">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              <HelpCircle className="mx-auto text-[#0f71cd] mb-3" size={28} />
              <h3 className="text-2xl font-bold text-[#0F141E] font-tt-talent" style={{ fontFamily: '"TT Talent", sans-serif' }}>Frequently Asked Questions</h3>
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  <button
                    ...
                    className="w-full flex items-center justify-between p-5 text-left font-tt-talent font-bold text-sm text-[#0F141E] hover:bg-slate-50/50 transition-colors"
                    style={{ fontFamily: '"TT Talent", sans-serif' }}
                  >
                    <span>{faq.question}</span>
                    <ChevronDown
                      size={18}
                      className={`text-slate-400 shrink-0 transition-transform duration-200 ${expandedFaq === index ? 'rotate-180 text-[#0f71cd]' : ''}`}
                    />
                  </button>
