  ...
  if (!college) {
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 text-center">
        <h2 className="text-2xl font-black text-slate-800 mb-2">College Profile Not Found</h2>
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-brand-500/30 selection:text-brand-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start justify-between">
            ...
            <div className="flex flex-row lg:flex-col gap-3 w-full lg:w-auto">
              <button onClick={() => handleApplyForCourse(null)} className="flex-1 lg:w-56 bg-[#110051] hover:bg-[#1a0073] text-white font-bold py-3.5 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer shadow-sm">
                      ...
                      {college.courses.map((c, i) => (
                        <tr key={i} className="hover:bg-slate-50/50 transition-colors group">
                          ...
                          <td className="py-5 px-6 text-right">
                            <button onClick={() => handleApplyForCourse(c.name)} className="inline-flex items-center justify-center px-4 py-2 bg-white border border-brand-200 text-brand-600 hover:bg-brand-50 font-bold rounded-lg transition-colors text-sm shadow-sm group-hover:border-brand-400">
            ...
            <div className="sticky top-40 space-y-6">
              ...
              <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-200 p-6 relative overflow-hidden">
                ...
                <form className="space-y-3">
                  ...
                  <button type="button" onClick={() => handleApplyForCourse(null)} className="w-full bg-[#110051] hover:bg-[#1a0073] text-white font-bold py-3.5 rounded-xl transition-all duration-300 mt-2 cursor-pointer shadow-sm">
                    Request Callback
                  </button>
      ...
      <div className="lg:hidden fixed bottom-0 inset-x-0 bg-white border-t border-brand-200 p-4 shadow-[0_-10px_20px_rgba(0,0,0,0.1)] z-50 flex gap-3">
        ...
        <button onClick={() => handleApplyForCourse(null)} className="flex-[2] bg-[#110051] hover:bg-[#1a0073] text-white font-bold py-3 rounded-xl transition-all duration-300 shadow-sm cursor-pointer">
          Apply Now
        </button>
      </div>
