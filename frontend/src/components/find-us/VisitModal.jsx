    ...
    <>
      ...
      >
        ...
        <div className="p-6 border-b border-slate-100 flex items-center justify-between text-left shrink-0">
          <div>
            <h3 className="text-xl font-bold text-[#0F141E] font-tt-talent" style={{ fontFamily: '"TT Talent", sans-serif' }}>{branch.name}</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="text-[13px] text-slate-700 pl-5 font-sans font-semibold">
                  <a href={`mailto:${branch.email}`} className="hover:text-[#0f71cd] transition-colors">
                    {branch.email}
                  </a>
                </div>
              </div>
